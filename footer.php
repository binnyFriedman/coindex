...
<div class="hidden-block">
    ...
    <svg height="150" width="400" >
        <defs>
            <linearGradient id="grad1" x1="10%" y1="30%" x2="10%" y2="0%" >
    ...
    <style>
        #curve_chart svg g > g > g:nth-child(2) g path {
            fill: url(#grad1);
        }
    </style>


    <div id="login-popup" class="curr-class">
        <div class="contein">
            <div class="title-part">
                <h3>כניסה ליצירת תיק אישי</h3>
                <p>התחבר באמצעות פייסבוק</p>
            </div>
            <div class="content-part">
                <a href="https://www.coindex.co.il/wp-login.php?loginSocial=facebook&amp;redirect=https%3A%2F%2Fwww.coindex.co.il%2Fcabinet%2F" data-plugin="nsl" data-action="connect" data-redirect="https://www.coindex.co.il/cabinet/" data-provider="facebook" data-popupwidth="475" data-popupheight="400">
                    <span>Facebook</span>
                </a>
            </div>
        </div>
    ...
    <div id="popup-login" class="curr-class">
        <div class="contein">
            <div class="title-part">
                <h3>כניסה ליצירת תיק אישי</h3>
                <p>התחבר באמצעות פייסבוק</p>
    ...
    <?php if ( get_field( "disable_popup", 5599 ) &&  !is_user_logged_in() ) : ?>

        <div id="uppered-popup" class="curr-class">
            <div class="contein">
                <div class="closer-pop"><span></span> <span></span></div>
                <div class="title-part">
                    <h3> <?php the_field( "title_popup", 5599 ); ?> </h3>
                </div>
                <div class="content-part">
                    <div class="texter">

                        <?php the_field( "popup_content", 5599 ); ?>

                    </div>
                </div>
                <div class="buttons-row to-center">
                    <!-- href="<?php //the_field( "link_url", 5599 ); ?>"
                    <a
                       data-fancybox="" data-src="#login-popup" href="javascript:;"
                       class="butt type2"
                        <?php if ( get_field( "link_open_in_new_tab", 5599 )  ) { echo 'target="_blank"' ;}?>
                    >
                        <span> <?php the_field( "button_text", 5599 ); ?> </span>
                    </a>
                    -->

                    <a class="butt type2"
                        href="/wp-login.php?loginSocial=facebook&amp;redirect=l%2Fcabinet%2F" data-plugin="nsl" data-action="connect" data-redirect="/cabinet/" data-provider="facebook" data-popupwidth="475" data-popupheight="400">
                        <span>Facebook</span>
                    </a>
                </div>
            </div>
...
<footer class="footer">
        ...
        <div class="mbox">
            <div class="siders">
                <div class="infoblock">
                    ...
                    <div class="texter">
                        <p><?php echo get_theme_mod( 'footer_slogan' ); ?></p>
                    </div>
                </div>
                <div class="menus">
                    <div class="menu">
                        <?php
                            $men1 = wp_get_nav_menu_object( 3 ) ;
                        ?>
                        <div class="header"> <?php echo $men1->name;?> </div>
                        <?php wp_nav_menu(array('menu'=> 3, 'menu_class' => '', 'container' => false )); ?>


                    </div>
                    <div class="menu">
                        <?php
                            $men2 = wp_get_nav_menu_object( 4 ) ;
                        ?>
    ...
    <div class="bottom-line">
        <div class="mbox">
            <p>כל הזכויות שמורות© ל- COINDEX.CO.IL</p>
        </div>
    </div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-116931395-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-116931395-1');
</script>
