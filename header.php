...
<script>
    ...
    var steakCounts = [];
    var searchText = '<?php echo isset($_GET["search"])??""; ?>';
</script>
...
<?php  if ( is_user_logged_in() ) :?>
    ...
    <script>
        logined = true;
        var steakNames = <?php echo json_encode($arr); ?>;
        var userID = <?php  echo $userID;  ?>;
        var steakCounts = <?php  echo json_encode($counts); ?>;
    </script>
                ...
                <div class="siders">
                    ...
                    <?php if ( is_user_logged_in() ) :?>
                        ...
                        <div class="user-part logined" >
                            ...
                            <a href="/cabinet/" class="loged">
                                <svg width="22px" height="18px" viewBox="0 0 22 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g id="nav1" transform="translate(-520.000000, -81.000000)" fill="#959595">
                                            <g id="Group-2" transform="translate(520.000000, 81.000000)">
                                                <path d="M17.8181464,7.29970662 L21,7.29970662 L21,6.50297419 C21,5.10984308 19.9591544,3.97130784 18.6390063,3.87320001 C18.5782883,3.86859742 18.5175704,3.86351035 18.4556848,3.86351035 L2.57444064,3.86351035 C2.0686135,3.79640944 1.67721632,3.34923156 1.67721632,2.8066105 C1.67721632,2.21723683 2.13773853,1.73953651 2.7056848,1.73953651 L17.7702727,1.73953651 C17.4153063,0.725755659 16.4814176,0 15.3805547,0 L2.54454873,0 C1.13939549,0 0,1.18189648 0,2.63946384 L0,6.50321643 L0,9.0758216 L0,15.3605362 C0,16.8190725 1.13939549,18 2.54454873,18 L18.4554513,18 C19.8613051,18 21,16.8193147 21,15.3605362 L21,13.7275859 L17.8181464,13.7275859 C16.109637,13.7275859 14.7198968,12.285522 14.7198968,10.5137674 C14.7198968,8.74152827 16.109637,7.29970662 17.8181464,7.29970662 Z" id="Fill-1"></path>
                                                <path d="M18.2499012,11.3333333 C17.8356381,11.3333333 17.5,10.9606216 17.5,10.5003293 C17.5,10.0400369 17.8356381,9.66666667 18.2499012,9.66666667 C18.6643619,9.66666667 19,10.0400369 19,10.5003293 C19,10.9606216 18.6643619,11.3333333 18.2499012,11.3333333 M21.2582824,8 L18.2030664,8 C16.9859548,8 16,9.1189781 16,10.5002433 C16,11.8812652 16.9861692,13 18.2030664,13 L21.2582824,13 L21.2582824,12.9980535 C21.667846,12.9980535 22,12.6211679 22,12.1562044 L22,8.84184915 C22,8.37688564 21.667846,8 21.2582824,8" id="Fill-3"></path>
                                            </g>
                                        </g>
                                    </g>
                                </svg>
...
//                                            get_currentuserinfo();
                    ...
                    <?php else: ?>
                        ...
                        <div class="user-part not-logined">
                            ...
                            <a data-fancybox data-src="#login-popup" href="javascript:;" class="loged">
                                <svg width="22px" height="18px" viewBox="0 0 22 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g id="nav1" transform="translate(-520.000000, -81.000000)" fill="#959595">
                                            <g id="Group-2" transform="translate(520.000000, 81.000000)">
                            ...
                            <a data-fancybox data-src="#login-popup" href="javascript:;" class="butt type1">
                                <span>כניסה</span>
                            </a>
                            <div class="hidden-butter">
                                <span></span>
                ...
                <div class="convert">
                    <div class="top-part">
                        ...
                        <ul>
                            <?php if ( is_user_logged_in() ) :?>
                                <li>
                                    <a href="/cabinet/">תיק אישי </a>
                                </li>
                            <?php else: ?>

                                <li>
                                    <a data-fancybox data-src="#login-popup" href="javascript:;">
                                        <span>כניסה</span>
                                    </a>
                                </li>
